...
public class MainActivity extends AppCompatActivity implements id.sch.smktelkom_mlg.learn.recyclerview3.adapter.HotelAdapter.IHotelAdapter {
    public static final String HOTEL = "hotel";
    public static final int REQUEST_CODE_ADD = 88;
    public static final int REQUEST_CODE_EDIT = 99;
    ArrayList<Hotel> mList = new ArrayList<>();
    id.sch.smktelkom_mlg.learn.recyclerview3.adapter.HotelAdapter mAdapter;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mAdapter = new id.sch.smktelkom_mlg.learn.recyclerview3.adapter.HotelAdapter(this, mList);
